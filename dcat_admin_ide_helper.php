...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection directory_name
     * @property Grid\Column|Collection directory_fullpath
     * @property Grid\Column|Collection directory_title
     * @property Grid\Column|Collection directory_intro
     * @property Grid\Column|Collection template_id
     * @property Grid\Column|Collection template_amp_id
     * @property Grid\Column|Collection page_title
     * @property Grid\Column|Collection page_description
     * @property Grid\Column|Collection page_keywords
     ...
     * @method Grid\Column|Collection directory_name(string $label = null)
     * @method Grid\Column|Collection directory_fullpath(string $label = null)
     * @method Grid\Column|Collection directory_title(string $label = null)
     * @method Grid\Column|Collection directory_intro(string $label = null)
     * @method Grid\Column|Collection template_id(string $label = null)
     * @method Grid\Column|Collection template_amp_id(string $label = null)
     * @method Grid\Column|Collection page_title(string $label = null)
     * @method Grid\Column|Collection page_description(string $label = null)
     * @method Grid\Column|Collection page_keywords(string $label = null)
     ...
     * @property Show\Field|Collection directory_name
     * @property Show\Field|Collection directory_fullpath
     * @property Show\Field|Collection directory_title
     * @property Show\Field|Collection directory_intro
     * @property Show\Field|Collection template_id
     * @property Show\Field|Collection template_amp_id
     * @property Show\Field|Collection page_title
     * @property Show\Field|Collection page_description
     * @property Show\Field|Collection page_keywords
     ...
     * @method Show\Field|Collection directory_name(string $label = null)
     * @method Show\Field|Collection directory_fullpath(string $label = null)
     * @method Show\Field|Collection directory_title(string $label = null)
     * @method Show\Field|Collection directory_intro(string $label = null)
     * @method Show\Field|Collection template_id(string $label = null)
     * @method Show\Field|Collection template_amp_id(string $label = null)
     * @method Show\Field|Collection page_title(string $label = null)
     * @method Show\Field|Collection page_description(string $label = null)
     * @method Show\Field|Collection page_keywords(string $label = null)
     ...
     * @method \App\Admin\Extensions\Form\PHPEditor php(...$params)
     */
    class Form {}
